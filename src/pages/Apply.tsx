      ...
      <main className="relative z-10">
        <section className="relative overflow-hidden pt-28 pb-20 md:pt-36 md:pb-28 hero-dark">
          <div className="container relative text-center max-w-3xl mx-auto">
            <motion.span initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="section-label-light !text-primary">Apply</motion.span>
        ...
        <section className="section-padding section-light">
          <div className="container max-w-2xl">
            <motion.form initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
              ...
              className="rounded-2xl border border-border bg-card p-8 shadow-xl md:p-12">
              <div className="flex flex-col gap-6">
                ...
                <Button size="lg" type="submit" className="mt-4 w-full h-14 rounded-full bg-primary text-base font-bold text-primary-foreground hover:bg-primary/90 shadow-xl shadow-primary/20">
