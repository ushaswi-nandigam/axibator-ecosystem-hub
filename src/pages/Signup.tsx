    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="flex min-h-screen items-center justify-center pt-16">
        ...
        >
          ...
          <p className="mt-1.5 text-sm text-muted-foreground">Join the Axibator founder community.</p>
          ...
          <form onSubmit={handleSubmit} className="mt-6 flex flex-col gap-4">
            ...
            <Button size="lg" type="submit" className="mt-2 w-full bg-primary text-primary-foreground font-semibold hover:bg-primary/90">Create Account</Button>
          </form>
