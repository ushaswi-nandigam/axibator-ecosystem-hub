      ...
      <div className="container relative">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <motion.div
            ...
            className="relative mt-20 flex flex-wrap justify-center gap-4 md:gap-8"
          >
            {["No mentors", "No structure", "No funding path", "No community"].map((item, i) => (
              <motion.div
                ...
                className="rounded-xl border border-border bg-card/80 px-5 py-3 text-sm text-muted-foreground shadow-sm"
              >
